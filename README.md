---
website: "Site Institucional do Município de Armamar"          # Entre as aspas escreve o nome do website
date: "06/08/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://www.cm-armamar.pt"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://www.cm-armamar.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "CM de Armamar"         # Entre as aspas escrever o nome do owner do website
...
<details>
  ...
  <ul aria-label="lista de relatórios já efetuados">
    <li><a href="06082026_report.html">(06/08/2026). Relatório {{ page.website }}</a></li>
  </ul>
</details>
